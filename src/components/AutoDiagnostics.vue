<template>
  <div class="container">
    ...
    <section class="info">
      ...
      <h2>Диагностика ДВС</h2>
      <ins>Почему она нужна?</ins>
      <p>Двигатель – сердце вашего автомобиля, и его исправная работа напрямую влияет на комфорт и безопасность вождения.
        Многие автовладельцы обращают внимание на проблемы только тогда, когда уже появляются серьёзные неисправности.
        Однако ранняя диагностика поможет избежать дорогостоящего ремонта.
        Загорелся <b>Check Engine</b> – это первый сигнал о сбоях в работе двигателя.
        Машина плохо заводится или работает нестабильно.
        Увеличился расход топлива.
        Планируете покупку подержанного авто.
      </p>
    ...
    <section>
      <div  class="onlineinfo">
        ...
        Покрытие 80+ автомобильных брендов Американского, Европейского, Азиатского и Китайского рынка
    ...
    <section class="info">
      ...
      АКПП – один из самых сложных и дорогих узлов автомобиля. Чтобы избежать серьезных поломок и дорогостоящего ремонта, важно проводить <b>периодическую диагностику</b>.
      <p><ins>Когда стоит проверить АКПП?</ins></p>
      <p>Автомобиль дергается при переключении передач.
        Задержки или рывки при переключении передач.
        Появились посторонние звуки (гул, скрежет).
        Повышенный расход топлива.
        Загорелся <b>Check Engine</b> или индикатор трансмиссии.</p>
    ...
    <section class="info">
      ...
      <p>
        Современный автомобиль — это сложный комплекс электронных систем, управляющих освещением, климат-контролем, безопасностью, мультимедиа и другими функциями.
        <b>Неисправности могут привести к серьезным сбоям и ухудшению комфорта вождения.</b></p>
        <p><ins>Когда нужна диагностика?</ins></p>
        Загорелись ошибки на приборной панели (ABS, ESP, подушки безопасности и др.).
        Не работают стеклоподъемники, дворники или система освещения.
        Перебои в работе мультимедиа и климат-контроля.
        Автомобиль не реагирует на кнопки и переключатели.
        Разряжается аккумулятор без видимой причины.

    </section>
    <section class="info">
      <h2>Дополнительный перечень услуг</h2>
